...
<style>
    ...
    function openIdChk(){
    	let openWin =window.open("IdCheckForm.jsp", "idwin", "width=400, height=350");
   ...
   <div id="frm_div">
    <form name="frm" action="/project/reg" method="post" onsubmit="return reg()">
        <table id="reg_tbl">
            ...
            <tr>
                <td><input type="text" placeholder="아이디" name="pInput" id="uid"><input type="button" value="중복확인" onclick="openIdChk()" id="idchkbtn"></td>
            </tr>
            <tr>
